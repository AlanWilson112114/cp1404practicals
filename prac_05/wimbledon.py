...
This program reads Wimbledon champions data from a CSV file and:
- displays how many times each player has won,
- displays the countries of all champions in alphabetical order.
"""

import csv

# Constants for file name and column indexes in CSV
...
def display_results(champion_to_count, countries):
    ...
    print(", ".join(sorted(countries))) # Join sorted country names into a string
